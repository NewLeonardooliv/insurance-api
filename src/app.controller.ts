...
export class AppController {
  ...
  @ApiQuery({ name: 'gender', type: String, required: true, description: 'Gender of the applicant' })
  @ApiQuery({ name: 'drivingExperience', type: Number, required: true, description: 'Years of driving experience' })
  @ApiQuery({ name: 'education', type: String, required: true, description: 'Educational background of the applicant' })
  @ApiQuery({ name: 'income', type: String, required: true, description: 'Income bracket of the applicant' })
  @ApiQuery({ name: 'vehicleYear', type: Number, required: true, description: 'Year of the vehicle' })
  @ApiQuery({ name: 'vehicleType', type: String, required: true, description: 'Type of the vehicle' })
